...
function Icon() {
  ...
  return (
    ...
    <div className={`flex text-white ${showactive && 'border-l-[6px] text-[#FA4B0C] border-solid border-[#FA4B0C] bg-slate-700'} hover:cursor-pointer gap-4 mt-2 p-4 px-10 sidee`} onClick={()=>setShowActive(true)} >
    ...
    <Link to='/clients'>
    <div className={`flex text-white ${showactive && 'border-l-[6px] text-[#FA4B0C] border-solid border-[#FA4B0C] bg-slate-700'} hover:cursor-pointer gap-4 mt-2 p-4 px-10 sidee`}>
    ...
    <div className={`flex mt-[15em] text-white ${showactive && 'border-l-[6px] text-[#FA4B0C] border-solid border-[#FA4B0C] bg-slate-700'} hover:cursor-pointer gap-4 mt-2 p-4 px-10 sidee`}>
